...
#     Debe incluir los métodos de push_left y push_right 
...
my_queue.push_right("Elemento 2")
my_queue.push_left("Elemento 1 (¡Al inicio!)")
my_queue.push_right("Elemento 3 (¡Al final!)")
